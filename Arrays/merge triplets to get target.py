...
# Solved 
# You are given a 2D array of integers triplets, where triplets[i] = [ai, bi, ci] 
# represents the ith triplet. You are also given an array of integers target = [x, y, z] 
# which is the triplet we want to obtain.

# To obtain target, you may apply the following operation on triplets zero or more times:

# Choose two different triplets triplets[i] and triplets[j] and update triplets[j] to 
